    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="price-item">
          <h3>Basic<br><span>(single page)</span></h3>
          <h4>129rs/mo</h4>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="price-item">
          <h3>Standard<br><span>(single page)</span></h3>
          <h4>249rs/mo</h4>
          <div class="price-sections">
            <h5>Main Page Include</h5>
            <ul>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="price-item">
          <h3>Advanced<br><span>(multi pages)</span></h3>
          <h4>499rs/mo</h4>
          <div class="price-sections">
            <h5>Main Page Include</h5>
            <ul>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="price-item">
          <h3>Featured<br><span>(multi pages)</span></h3>
          <h4>999rs/mo</h4>
          <div class="price-sections">
            <h5>Main Page Include</h5>
            <ul>

        ...
        <div class="price-item">
          ...
          <div class="price-sections">
            ...
            <ul>
              ...
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">About Us/Why Us</li>
          ...
          <div class="price-sections">
            ...
            <ul>
              ...
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">1 Services(1 per month)</li>
        ...
        <div class="price-item">
          ...
          <div class="price-sections">
            ...
            <ul>
              ...
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">SSL Certificate</li>
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">Maintenance</li>
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">2 Services(2 per month)</li>
        ...
        <div class="price-item">
          ...
          <div class="price-sections">
            ...
            <ul>
              ...
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">SSL Certificate</li>
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">Maintenance</li>
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">4 Services(4 per month)</li>
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">favicon</li>
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">Icons</li>
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">Images</li>
          ...
          <div class="price-sections">
            <h5>Delivery Period</h5>
            <ul>
              <li><img src="{{asset('assets/img/arrow.png')}}" class="img-fluid">5-7 days</li>
            </ul>
          </div>
        </div>
      </div>

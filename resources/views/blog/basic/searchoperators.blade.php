          ...
          <article class="single-blog-item">
            ...
            <div class="single-blog-points">
              ...
              <div class="single-blogs-steps">
                ...
                <div class="sbs-img">
                  <img src="{{asset('assets/img/blog/operators/gso/cache.PNG')}}" class="img-fluid" alt="cache operator">
                </div>
              ...
              <div class="single-blogs-steps">
                ...
                <div class="sbs-img">
                  <img src="{{asset('assets/img/blog/operators/gso/site.PNG')}}" class="img-fluid" alt="site operator">
                </div>
              ...
              <div class="single-blogs-steps">
                ...
                <div class="sbs-img">
                  <img src="{{asset('assets/img/blog/operators/gso/related.PNG')}}" class="img-fluid" alt="related operator">
                </div>
              ...
              <div class="single-blogs-steps">
                ...
                <div class="sbs-img">
                  <img src="{{asset('assets/img/blog/operators/gso/link.PNG')}}" class="img-fluid" alt="link operator">
                </div>
